...
public class BasicNavigationTests implements HttpContext {
	private Bundle bundle;
	private String bundlePath;

	public BasicNavigationTests(Bundle bundle) {
		this.bundle = bundle;
	}

	public BasicNavigationTests(Bundle bundle, Properties authProperties) {
		this.bundle = bundle;
	}

	public BasicNavigationTests(Bundle bundle, String bundlePath, Properties authProperties) {
